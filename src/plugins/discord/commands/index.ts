...
export const SLASH_COMMANDS = [
  ...
  new SlashCommandBuilder()
    .setName("switch")
    .setDescription("Switch to a different agent in the current session")
    .addStringOption((o) =>
      o
        .setName("agent")
        .setDescription("Agent name to switch to")
        .setRequired(false),
    )
    .addStringOption((o) =>
      o
        .setName("label")
        .setDescription("Toggle agent label in history (on/off)")
        .setRequired(false)
        .addChoices(
          { name: "on", value: "on" },
          { name: "off", value: "off" },
